  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-rill-elements-item-contentDefault hover:text-rill-elements-item-contentActive hover:bg-rill-elements-item-backgroundActive':
          !selected,
        'bg-rill-elements-item-backgroundAccent text-rill-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-rill-elements-item-backgroundActive text-rill-elements-item-contentDefault': !selected,
        'bg-rill-elements-item-backgroundAccent text-rill-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-rill-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
